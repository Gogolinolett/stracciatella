...
- **Landing brake**: Activates after any sprint jump landing (prevSegGap ≥ 3) on an intermediate platform, OR when transitioning from gap ≥ 2 to a smaller gap. At high speed (>0.1 b/t), faces velocity direction and presses backward to actively decelerate. At low speed (≤0.1 b/t), releases all keys and lets friction handle it. Targets: gap≤1→0.03, gap≤2→0.04, gap≥3→0.08
